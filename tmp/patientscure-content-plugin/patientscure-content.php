...
function patientscure_register_content_meta() {
    $meta_fields = array(
        'disease' => array(
            'common_names' => array( 'type' => 'array', 'single' => false ),
            ...
            'symptoms' => array( 'type' => 'array', 'single' => false ),
            'causes' => array( 'type' => 'array', 'single' => false ),
            'ayurvedic_perspective' => array( 'type' => 'string', 'single' => true ),
            'diet' => array( 'type' => 'array', 'single' => false ),
            'lifestyle' => array( 'type' => 'array', 'single' => false ),
            'precautions' => array( 'type' => 'array', 'single' => false ),
            'when_to_seek_medical_care' => array( 'type' => 'string', 'single' => true ),
            'faq' => array( 'type' => 'array', 'single' => false ),
            'references' => array( 'type' => 'array', 'single' => false ),
            'related_diseases' => array( 'type' => 'array', 'single' => false ),
            'related_remedies' => array( 'type' => 'array', 'single' => false ),
            'related_ingredients' => array( 'type' => 'array', 'single' => false ),
        ),
        'remedy' => array(
            'purpose' => array( 'type' => 'string', 'single' => true ),
            'ingredients' => array( 'type' => 'array', 'single' => false ),
            ...
            'who_should_avoid' => array( 'type' => 'array', 'single' => false ),
            'references' => array( 'type' => 'array', 'single' => false ),
        ),
        'ingredient' => array(
            'common_names' => array( 'type' => 'array', 'single' => false ),
            ...
            'traditional_uses' => array( 'type' => 'array', 'single' => false ),
            'preparation' => array( 'type' => 'array', 'single' => false ),
            'precautions' => array( 'type' => 'array', 'single' => false ),
            'related_remedies' => array( 'type' => 'array', 'single' => false ),
            'related_diseases' => array( 'type' => 'array', 'single' => false ),
        ),
