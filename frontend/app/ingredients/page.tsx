...
export default async function IngredientsPage() {
  const ingredients = await dataService.getIngredients();
        ...
        <div className='px-4 py-8 sm:px-6 lg:px-8'>
          <div className='mx-auto max-w-7xl'>
            ...
            <nav className='mb-6 flex items-center space-x-1 text-sm text-text/50 dark:text-text/40'>
              ...
              <span className='font-medium text-text/80 dark:text-text/200'>Ingredients</span>
            </nav>
            ...
            {/* Ingredients Grid - capped width and sensible columns */}
